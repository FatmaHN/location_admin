            ...
            Form(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                      "  Entrez votre email pour accéder \n à un lien pour restaurer  votre \n mot de passe",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.ubuntu(
                          color: const Color(0xFF3C2DA5), fontSize: 19)),
                  const SizedBox(
                    height: 20,
                  ),
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            labelStyle: const TextStyle(color: Color(0xFFFFBA5F)),
                            ...
                            errorBorder: OutlineInputBorder(
                                ...
                                borderSide: const BorderSide(
                                    color: Color(0xFFFF2600), width: 2)),
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return const AlertDialog(
                                  content: Text(
                                      "vérifiez votre e-mail s'il vous plaît"),
                                );
                              });
                          }
                        },
